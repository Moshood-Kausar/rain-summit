...
const whyData = [
    {
        ...
        body: 'Feel the rush and be inspired as 10 teams compete for top honors in Hackathon 1.0, winning up to 1 million naira prize up for grabs'
    },
    {
        heading: 'Engage with Industry Giants',
        body: 'From Leaders in across fields AI and Robotics , come over to listen and be inspired to start your own revolution'
    },
    {
    ...
    },
    {
        ...
        body: 'From Scholarships to career-boosting connectins, this summit plans to open doors that could change your future'
    },
]
export const About = () => {
    return (
        <section className="py-11">
            ...
            <div className={`mt-8 md:mt-11 grid grid-cols-1 md:grid-cols-2 gap-y-9 md:gap-y-[50px]`}>
                {
                    whyData.map((d,idx)=> (
                    <div key={idx} className={`flex gap-2 w-[90%] ${idx % 2 === 1? 'md:justify-self-end' : 'md:justify-self-start'}`}>
                        <div>
                            <FaRegCheckCircle size={20} color="#4C4E1C" className="mt-[5px]" />
                        </div>
